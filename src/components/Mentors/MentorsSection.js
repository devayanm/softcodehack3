...
function MentorsSection() {
  ...
  return (
    <div className='text-center font-extrabold bg-black pb-6'>
      <p className='text-[#FFFFFF] text-4xl font-extrabold mb-4'>KNOW YOUR MENTORS</p>
      <div className='w-full h-[600px] relative group bg-black flex items-center justify-center'>
        <div
          style={{ backgroundImage: `url(${slides[currentIndex].url})` }}
          className='w-[60%] h-full rounded-2xl bg-center bg-cover duration-500'
          alt={slides[currentIndex].alt}></div>
